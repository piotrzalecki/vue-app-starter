<template>
    <div class="container">
        <div class="row">
            ...
            <hr>
            <table v-if="this.ready" class="table table-compact table-stripped">
                <thead>
                    <tr>
                        <th>User</th>
                        <th>Email</th>
                ...
                <tbody>
                    <tr v-for="u in this.users" v-bind:key="u.id">
                        ...
                        <td v-if="u.token.id > 0">
                            ...
                            <span class="badge bg-success" @click="logUserOut(u.id)">Logged in</span></a>
                        </td>
                        <td v-else>
...
export default {
    ...
    methods: {
        logUserOut(id) {
            if (id !== store.user.id){
                notie.confirm({
                    text: "Are tou sure you want to log this user out?",
                    submitText: "Log Out",
                    submitCallback: () =>  {
                ...
                this.$emit("error", "You can't log yourself out this way!");
            }
